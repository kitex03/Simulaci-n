...
final float G =9.8;       // Acceleration due to gravity (m/(s·s))

final int N_H = 30;         // Number of nodes of the object in the horizontal direction
final int N_V = 15;         // Number of nodes of the object in the vertical direction

final float D_H = 3.0;     // Separation of the object's nodes in the horizontal direction (m)
...
final float K_E = 300;      // Constante elástica de los muelles de la malla(N/m)
final float K_D = 2;      // Constante de amortiguación lineal de los muelles de la malla(kg/s)
...
final PVector VIENTO = new PVector(1,-1,1); // Viento (m/s)
//...
//...
//...
